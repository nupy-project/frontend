  ...
  return (
    ...
    >
      ...
      <div className='fv-row mb-8'>
        <label className='form-label fw-bolder text-gray-900 fs-6'>Nombre completo</label>
        <input
      ...
      <div className='fv-row mb-8'>
        <label className='form-label fw-bolder text-gray-900 fs-6'>Indicativo del país</label>
        <select
      ...
      <div className='fv-row mb-8'>
        <label className='form-label fw-bolder text-gray-900 fs-6'>Móvil</label>
        <input
